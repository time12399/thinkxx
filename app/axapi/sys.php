...
use app\axapi\command\OrderClean;
use app\axapi\command\UserAgent;
use app\axapi\command\UserAmount;
use app\axapi\command\UserTransfer;
use app\axapi\command\UserUpgrade;
use app\axapi\service\OrderService;
use app\axapi\service\RebateService;
use app\axapi\service\UserBalanceService;
